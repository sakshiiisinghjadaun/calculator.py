...
bg='cadet blue', commad= added_value.backspace)
...
bg= 'cadet blue', command= added_value.sin)
btnsin.grid(row=2, column=3, pady=1)

#===================================Scientific================================================================#

btnAdd = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="+",bg='cadet blue',
                command= lambda:added_value.operatiion("add"))
btnAdd.grid(row=3, column=3, pady=1)

btnSub = Button(MainFrame, width=6, height=2, font=('arial',16, 'bold'), bd=4, text="-",
bg='cadet blue',command = lambda:added_value.opaeration("sub"))
...
bg='cadet blue',command = added_value.operation("divide"))
...
bg='cadet blue', command= added_value.sum_of_total)
